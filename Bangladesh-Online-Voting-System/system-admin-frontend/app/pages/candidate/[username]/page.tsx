...
export default function CandidateUsername({ params }: { params: { username: string } }) {
    ...
    return (
        <div>
            <br />
            <h1 className="text-4xl font-bold text-red-900 pl-4">Candiate Details</h1>
            <div className='flex item-center justify-center'>
                { user ? (
                            ...
                            <div className="card-body">
                                ...
                                <table className="border-collapse w-full">
                                    <tbody>
                                        ...
                                        <TableRow label="Party Name" value={user.party_name} />
                                        <TableRow label="Position" value={user.position} />
                                        <TableRow label="Election Location" value={user.election_location} />
                                    </tbody>
                                </table>
                            </div>
                        </div>
                    ...
                    <h1 className="text-2xl font-bold text-red-900 pl-4 flex justify-center"><br /><br />No Candidate Found!</h1>
                )}
            </div>
        </div>
    );
